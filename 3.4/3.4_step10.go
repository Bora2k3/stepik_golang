...
func main() {
	var value1 interface{} = 95.000 //float64
	var value2 interface{} = 80.000 //float64
	var operation interface{} = "/" //string + - * /
...
func res(a, b float64, op string) float64 {
	switch op {
	case "+":
		return a + b
	case "-":
